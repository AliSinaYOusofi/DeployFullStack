...
const MovieCards = ({title, urlEndPoint, id}) => {
    ...
    return (
        ...
        <div id={"card"} className="cards w-full h-full text-el   flex flex-row flex-wrap mt-20 items-center justify-center">
            ...
            <div   className="w-full h-full flex flex-row flex-wrap gap-x-2     items-center justify-center">
                {
                    ...
                    movies.map( (item, index) => {
                        ...
                        return (
                            ...
                            <div id={item?.id} key={item?.id} ref={parentDivRef}  onClick={(event) => sendMovieDetails(event)} className="mt-4 cursor-pointer  group hover:scale-[1] transition-all">
            ...
            <div className="fixed w-[20rem] py-0 rounded-md top-[90%] lg:top-[85%] lg:h-[10%] h-[5%]
            flex flex-row justify-around items-center transition-all duration-200 opacity-30 hover:opacity-80 bg-black">
